...
//       navigator.mediaDevices.getUserMedia({video:video,audio:audio}).then(getUserMediaSuccess).then((stream)=>{ }).catch((e)=>{
//         console.log(e)
//       })
//     }else{
//       try{
...
//       socketRef.current.emit("join-call" , {room:window.location.href,username:username});
...
// if(screen){
//   if(navigator.mediaDevices.getDisplayMedia){
//     navigator.mediaDevices.getDisplayMedia({video:true,audio:true}).then(getDisplayMediaSuccess)
//                     .then((stream) => { })
//                     .catch((e) => console.log(e))
//   }
// }
...
//   socketRef.current.emit("chat-message", window.location.href, message);

//   // Immediately add it locally too
...
export default function VideoMeetComponent() {
    ...
    const getPermissions = async () => {
        ...
        userMediaStream.getVideoTracks().forEach(track => (track.enabled = true));
...
//             track.enabled = newVideoState;  // turn camera on/off
//         });
//     }
// };
...
//             track.enabled = newAudioState;  // turn mic on/off
//         });
//     }
// };
